...
#path_to_files = "/home/python/github/pyneng/exercises/25_db/task_25_3"
path_to_files = "/home/python/github/pyneng/exercises/25_db/task_25_3/new_data"
        ...
        if len(read_from_db) == 0:
            ...
            for line in mac_lists:
                ...
                if new_mac == None:
                    ...
                    mac_from_db, ip_from_db, vlan_from_db, int_f_from_db, switch_from_db, active = new_mac
